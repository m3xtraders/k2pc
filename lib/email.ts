      ...
      <div style="padding: 24px;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px; font-size: 14px;">
          ...
          <tr style="border-bottom: 1px solid #f0f0f0;">
            ...
            <td style="padding: 8px 0; color: #1c1917;">${lead.city || "GTA (Not specified)"}</td>
          </tr>
          <tr style="border-bottom: 1px solid #f0f0f0;">
        ...
        <div style="margin-bottom: 24px;">
          <h4 style="margin: 0 0 8px 0; color: #44403c; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px;">Customer Message / Notes:</h4>
          <div style="background-color: #fafaf9; border: 1px solid #e7e5e4; padding: 14px; border-radius: 8px; color: #292524; font-size: 14px; line-height: 1.5; white-space: pre-wrap;">
            ${lead.message || "No extra comments provided."}
          </div>
        </div>

        <div style="text-align: center; margin-top: 24px; padding-top: 20px; border-top: 1px solid #f5f5f4;">
          <a href="tel:${lead.phone.replace(/[^0-9+]/g, "")}" style="background-color: #BE2320; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 14px; display: inline-block; margin-right: 8px;">
            📞 Call Customer Now
          </a>
        </div>
      </div>

      <div style="background-color: #fafaf9; padding: 12px 24px; text-align: center; border-top: 1px solid #f0f0f0; font-size: 11px; color: #a8a29e;">
        This automated notification was generated by your website CRM lead capture system.
      </div>
    </div>
  `;
  ...
  const htmlContent = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e5e5e5; border-radius: 12px; overflow: hidden;">
      ...
      <div style="background-color: #1c1917; padding: 16px 24px; text-align: center; font-size: 12px; color: #a8a29e;">
        ...
        Ontario Ministry of the Environment Licensed & Insured.
      </div>
    </div>
  `;
