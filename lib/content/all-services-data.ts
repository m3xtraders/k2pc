...
export const ALL_SERVICES_CATALOG: FullServiceItem[] = [
  // 1. ANTS
  {
    id: "ant-control",
...
export const STATIC_SERVICES_FALLBACK: Service[] = ALL_SERVICES_CATALOG.map((item) => ({
  id: item.id,
  title: item.title,
  slug: item.slug,
  ...
  icon: item.icon,
  pestCategory: item.pestCategory,
  targetPests: item.targetPests,
  signsOfInfestation: item.signsOfInfestation,
  treatmentProcess: item.treatmentProcess,
  pricingStartsAt: item.pricingStartsAt,
