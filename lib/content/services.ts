...
export const SERVICES: Service[] = [
  {
    ...
    fullDescription: "Ant infestations in Saskatchewan range from moisture-loving carpenter ants damaging structural timbers to stubborn pavement and pharaoh ants colonizing heating conduits. Our IPM approach combines non-repellent baiting systems that worker ants carry straight back to the queen with perimeter liquid barriers to stop re-entry.",
    icon: "ant",
  ...
  },
  {
    ...
    fullDescription: "As Canadian temperatures drop in autumn, field mice and rodents seek heat, shelter, and food inside Saskatoon homes. K2PC Pest Control provides a multi-phase solution: rapid removal via tamper-resistant baiting and mechanical trapping, followed by heavy-duty exclusion sealing of entry holes down to 1/4 inch.",
    icon: "rodent",
  ...
  },
  {
    ...
    faqs: [
      {
        question: "Are spiders in Saskatchewan venomous to humans?",
        answer: "Most common Saskatchewan spiders (like cellar spiders, wolf spiders, and house spiders) are harmless. Black widows are extremely rare. Yellow sac spider bites can occasionally cause mild localized irritation.",
      },
    ],
  },
  {
    ...
    shortDescription: "Comprehensive home defense plans for houses, townhomes, and condos across Saskatoon & surrounding communities.",
    fullDescription: "Protect your sanctuary with year-round pest defense tailored to Prairie climate cycles. From ants and mice to spiders and seasonal invaders, our licensed exterminators keep your family safe using eco-conscious Integrated Pest Management (IPM).",
    icon: "home",
  ...
  },
  {
    ...
    shortDescription: "Audit-ready IPM programs for restaurants, warehouses, food processing facilities, and office buildings in Saskatoon.",
  ...
  },
  {
    ...
    fullDescription: "Wood-destroying insects cause severe structural damage if left untreated. K2PC provides non-invasive thermal detection, moisture analysis, and subterranean liquid termiticide barriers across Saskatoon.",
    icon: "shield",
    featuredImage: "/images/services/default-service.jpg",
    pestCategory: "insects",
    targetPests: ["Subterranean Termites", "Carpenter Ants"],
    signsOfInfestation: [
  ...
  },
  {
    ...
    shortDescription: "Humane 1-way door eviction and roofline exclusion for raccoons, squirrels, skunks, and bats.",
    fullDescription: "Prairie wildlife often nests in attics, chimneys, and under decks. We utilize Ministry-approved 1-way door eviction systems and heavy-gauge wire mesh sealing to ensure animals exit safely without harm.",
    icon: "bug",
    featuredImage: "/images/services/residential.jpg",
    pestCategory: "wildlife",
    targetPests: ["Raccoons", "Squirrels", "Skunks", "Bats", "Birds"],
    signsOfInfestation: [
    ...
    faqs: [
      {
        ...
        answer: "Never. All wildlife removal is 100% humane, using one-way eviction doors and release protocols in accordance with Saskatchewan wildlife protection regulations.",
      },
    ],
  },
  {
    ...
    fullDescription: "Prevent pests before they breach your home's perimeter. Our 4-season protection program delivers exterior barrier sprays, rodent station servicing, and soffit treatments tailored to Saskatchewan climate cycles.",
    icon: "calendar",
    featuredImage: "/images/services/default-service.jpg",
    pestCategory: "prevention",
