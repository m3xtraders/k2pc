...
const TRUST_ITEMS: TrustItem[] = [
  ...
  },
  {
    ...
    renderIcon: () => (
      /* Official National Flag of Canada (Pantone Standards) */
      <svg
        className="w-16 h-10 sm:w-18 sm:h-11 lg:w-20 lg:h-12 transition-transform duration-300 group-hover:scale-110 drop-shadow-md rounded-md overflow-hidden border border-stone-200/90 shrink-0"
        xmlns="http://www.w3.org/2000/svg"
